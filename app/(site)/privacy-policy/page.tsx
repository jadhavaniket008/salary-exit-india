...
export default function PrivacyPolicyPage() {
  return (
    ...
    >
      ...
      <p>
        When <code className="rounded bg-surface-raised px-1 py-0.5 text-sm">NEXT_PUBLIC_ENABLE_CONSENT_BANNER=true</code>, SalaryExit
        shows an on-site banner that lets you accept or reject non-essential processing. Your choice is stored
        in <code className="rounded bg-surface-raised px-1 py-0.5 text-sm">localStorage</code> under a
        project-specific key and is used to gate optional script loading (for example Google Analytics, Plausible,
        or AdSense) in <code className="rounded bg-surface-raised px-1 py-0.5 text-sm">ThirdPartyRootScripts</code>.
      ...
      <p>
        If <code className="rounded bg-surface-raised px-1 py-0.5 text-sm">NEXT_PUBLIC_PLAUSIBLE_DOMAIN</code> is set, a lightweight
