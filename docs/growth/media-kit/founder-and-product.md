...
1. Between ₹12,00,000 and ₹12,70,587 taxable income, Section 87A's new-regime marginal relief taxes every additional rupee of income tax (before cess) at exactly 100% — and, including the 4% health & education cess, the marginal rate on total tax liability is 104%. Not a hard cliff, but a real, precisely-bounded zone where a raise produces no net take-home gain.
