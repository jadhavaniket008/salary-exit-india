...
|------------|-----------------|---------------|------------------------|-----------------|---------------------------|-------------------|
| **Income tax core** (`income-tax.ts`) | Progressive slabs; cess = 4% of tax after rebate; 87A old/new; new-regime 87A marginal relief caps tax before cess at (taxable − limit) just above the limit | Slab arithmetic + marginal relief for given taxable income | Old-regime 87A simplified vs statute; no surcharge or surcharge marginal relief | FY slabs from config | Taxable income (after std ded, deductions) | Not a substitute for filing; verify FY |
